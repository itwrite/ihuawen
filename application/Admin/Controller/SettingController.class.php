...
class SettingController extends AdminbaseController{
	...
	public function site_post(){
		if (IS_POST) {
			...
			$configs["SP_DEFAULT_THEME"]=$options['site_tpl']?$options['site_tpl']:'simplebootx';
			$configs["DEFAULT_THEME"]=$options['site_tpl'];
			$configs["SP_ADMIN_STYLE"]=$options['site_adminstyle']?$options['site_adminstyle']:"flat";
