...
class AdminTermController extends AdminbaseController {
	...
	protected $taxonomys=array("article"=>"文章",'magazine'=>'杂志',"picture"=>"图片");
    ...
    public function index(){
		$result = $this->terms_model->where(array('status'=>array("NEQ",-1)))->order(array("listorder"=>"asc"))->select();
	...
	public function add(){
	 	...
	 	$tree->icon = array('&nbsp;&nbsp;&nbsp;│ ', '&nbsp;&nbsp;&nbsp;├─ ', '&nbsp;&nbsp;&nbsp;└─ ');
	 	$tree->nbsp = '&nbsp;&nbsp;&nbsp;';
	 	$terms = $this->terms_model->where(array('status'=>array("NEQ",-1)))->order(array("path"=>"asc"))->select();
	...
	public function edit(){
		...
		$tree->icon = array('&nbsp;&nbsp;&nbsp;│ ', '&nbsp;&nbsp;&nbsp;├─ ', '&nbsp;&nbsp;&nbsp;└─ ');
		$tree->nbsp = '&nbsp;&nbsp;&nbsp;';
		$terms = $this->terms_model->where(array("term_id" => array("NEQ",$id), "path"=>array("notlike","%-$id-%"),'status'=>array("NEQ",-1),'taxonomy'=>$data['taxonomy']))->order(array("path"=>"asc"))->select();
