/**
 * Created by zzpzero on 2017/7/27.
 */
...
;
DEFAULT_URL = typeof DOCUMENT_PATH == 'undefined' ? DEFAULT_URL : DOCUMENT_PATH;
var pdfjsWebLibs;
{
    ...
    (function () {
            ...
            var PDFPageView = function PDFPageViewClosure() {
                ...
                PDFPageView.prototype = {
                    ...
                    draw: function PDFPageView_draw() {
                        ...
                        canvasWrapper.style.width = (parseFloat(String(div.style.width).replace('px',''))-18)+'px';
                        canvasWrapper.style.height = (parseFloat(String(div.style.height).replace('px',''))-18)+'px';
            ...
            var PDFViewer = function pdfViewer() {
                ...
                PDFViewer.prototype = {
                    ...
                    _setScaleUpdatePages: function pdfViewer_setScaleUpdatePages(newScale, newValue, noScroll, preset) {
                         ...
                         */
                        console.log("ASDF");
                        var _pagesCount = this._pages.length;
                        var _viewport = this._pages[0].viewport;
                        this.viewer.style.width=this._pages.length*(Math.floor(_viewport.width)+20)+"px";
        ...
        (function (root, factory) {
            ...
            function configure(PDFJS) {
                PDFJS.imageResourcesPath = 'public/js/pdfjs/web/images/';
                PDFJS.workerSrc = 'public/js/pdfjs/build/pdf.worker.js';
